...
namespace Canducci.GraphQLQuery.MSTest
{
    ...
    public class UnitTestGraphQLServerCommand
    {
        ...
        public IRequestExecutor RequestExecutor { get; set; }
        ...
        public void InitGraphQLServerCommand()
        {
            ...
            Schema = SchemaBuilder.New()
                  ...
                  .AddQueryType<Query>()                  
                  .Create();
            RequestExecutor = Schema.MakeExecutable();
        }
        ...
        public void TestSourceAddWithParameter()
        {
            TypeQL typeQL = new TypeQL(
               new Variables("getSourceAdd",
                  ...
                  new Variable<DateTime?>("time", null)
               ),
               new QueryType("source_param_add",
                  new Fields(
                     new Field("id"),
        ...
        public void TestSourceListWithDirectiveInclude()
        {
            TypeQL typeQL = new TypeQL(
               ...
               new QueryType(
                  "sources",
                  new Fields(
                     new Field("id", new Canducci.GraphQLQuery.Interfaces.IDirective[] { new Include("status") }),
                     new Field("name")
                  )
               )
            );
        ...
        public void TestSourceListWithDirectiveCustom()
        {
            TypeQL typeQL = new TypeQL(
               ...
               new QueryType(
                  ...
                  new Fields(
                     new Field("id"),
                     new Field("name", new Canducci.GraphQLQuery.Interfaces.IDirective[] { new Queries.Types.Upper(), new Skip("source") }),
                     new Field("active")
                  )
               )
            );
