...
namespace Canducci.GraphQLQuery
{
   public class QueryType : IQueryType
   {
      ...
      public QueryType(string name, Fields fields) : this(name, "", null, fields) { }
      public QueryType(string name, Arguments arguments, Fields fields) : this(name, "", arguments, fields) { }
      public QueryType(string name, string alias, Fields fields) : this(name, alias, null, fields) { }
