...
namespace Canducci.GraphQLQuery.CustomTypes.MSTest
{
   ...
   public class UnitTestTimeSpanValueNodeDefault
   {
      ...
      {
         TimeSpanValueNode = new TimeSpanValueNode(NodeKind.ScalarTypeExtension, TimeSpan.Parse("01:01:01"), null);
      }

      [TestMethod]
      public void TestTimeSpanValueNode()
      {
         Assert.AreEqual(TimeSpanValueNode.Kind, NodeKind.ScalarTypeExtension);
